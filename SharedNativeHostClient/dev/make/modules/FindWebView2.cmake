...
function(setup_webview2_targets)
    ...
    elseif(PLATFORM_MAC)
        ...
        if (IS_DIRECTORY ${framework_dir})
            ...
            set(WEBVIEW2_FRAMEWORK_PATH "${framework_dir}/MSWebView2.framework" PARENT_SCOPE)
            set(WEBVIEW2_APP_NAME "Microsoft Edge WebView2.app")
            set(WEBVIEW2_APP_NAME ${WEBVIEW2_APP_NAME} PARENT_SCOPE)
            set(WEBVIEW2_APP_PATH "${framework_dir}/${WEBVIEW2_APP_NAME}" PARENT_SCOPE)
            message(STATUS "WV2 framework_dir: ${framework_dir}")
            set(was_found TRUE)
        else()
